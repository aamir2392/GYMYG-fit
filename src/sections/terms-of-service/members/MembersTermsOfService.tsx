...
import { termsData } from "@/constants/termsOfServiceData";

export default function MembersTermsOfService() {
  ...
  return (
    <div className="container max-w-4xl mx-auto px-4 py-36">
      <motion.div
      ...
      >
        ...
        <div className="space-y-4 text-center">
          <div className="inline-flex items-center justify-center p-2 bg-rose-100 rounded-full">
            <termsData.header.icons.main className="h-6 w-6 text-rose-500" />
          </div>
          ...
          <div className="flex items-center justify-center gap-2 text-sm text-muted-foreground">
            <termsData.header.icons.clock className="h-4 w-4" />
            <span>Last updated:</span>
            <div className="flex items-center gap-1">
              <termsData.header.icons.calendar className="h-4 w-4" />
              <time dateTime={termsData.header.lastUpdated}>
                {new Date(termsData.header.lastUpdated).toLocaleDateString(
                  "en-US",
                  {
                    year: "numeric",
                    month: "long",
        ...
        <Card className="border-none shadow-lg bg-gradient-to-br from-rose-50 to-white">
          <CardContent className="pt-6">
            {termsData.introduction.paragraphs.map((paragraph, index) => (
              <p
                key={index}
        ...
        <div className="hidden md:block">
          <Tabs defaultValue="eligibility-requirements" className="w-full">
          ...
          <div className="space-y-8 mt-12">
            {termsData.sections.slice(3).map((section) => (
